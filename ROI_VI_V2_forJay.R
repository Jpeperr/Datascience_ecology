...
library(imager)
library(tools)
setwd("C:/Users/jaylo/Documents/GitHub/Datascience_ecology")
...
img_folder <- "data/raw/phenology_raw/H5R0-01"  # <-- replace with your image folder path
...
# load store ROI data ----
load("data/processed/roi_output/roi.data.RData")
roi.data

# Plot the mask of the ROI
library(raster)
plot(roi.data$RO1$mask)
